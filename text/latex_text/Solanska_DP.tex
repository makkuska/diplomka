...
\newcommand{\tab}[1]{\hspace{.2\textwidth}\rlap{#1}}
  ...
  \begin{document}
    ...
    \section{TEORETICKÁ VÝCHODISKA}
      \input{kapitoly/teorie/1_teorie_uvod.tex}
      \input{kapitoly/teorie/2_vymezeni_pojmu.tex}
      \input{kapitoly/teorie/3_replikace.tex}
      \input{kapitoly/teorie/4_arcgis_produkty.tex}
      \input{kapitoly/teorie/5_pouzite_programove_prostredky.tex}
      \input{kapitoly/teorie/6_nastroje_pro_replikaci.tex}
    
    %------------------------------------------------------------------------- VÝSLEDKY
    \newpage
    \section{NÁVRH A KONFIGURACE REPLIKACE}
      \input{kapitoly/konfigurace/0_konfigurace_uvod.tex}
      \input{kapitoly/konfigurace/1_navrh_replikacniho_reseni.tex}
      \input{kapitoly/konfigurace/2_priprava_prostredi_pro_konfiguraci.tex}
      \input{kapitoly/konfigurace/3_konfigurace_replikace.tex}
      \input{kapitoly/konfigurace/4_rozlozeni_zateze.tex}
      \input{kapitoly/konfigurace/6_testovani_vykonu.tex}
