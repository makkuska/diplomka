...
\newcommand{\tab}[1]{\hspace{.2\textwidth}\rlap{#1}}
  ...
  \begin{document}
    ...
    \begin{dedication}
      ...
      Dále děkuji konzultantům Boudewijn van Leeuwen a Zalan Tobak působích na Universitě v Szegedu v Maďarsku za inspirativní podněty při vypracování této práci. 
      \vspace{4em}
    \end{dedication}
    ...
    %------------------------------------------------------------------------- VÝSLEDKY
    \newpage
    \section{NÁVRH A IMPLEMENTACE REPLIKACE}
      \input{kapitoly/implementace/3_priprava_prostredi_pro_konfiguraci.tex}
      \input{kapitoly/implementace/5_implementace_replikace.tex}
