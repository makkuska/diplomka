...
<html lang="cs-cz" dir="ltr">
  <head>
    ...
    <title>Solanská - Synchronizace a replikace geodat v prostředí Esri platformy | Cíle práce</title>
  </head>
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        ...
        <a class="blog-nav-item active" href="cile.php">Cíle práce</a>
        ...
        <a class="blog-nav-item" href="summary.php">Summary</a>
        </nav>
      </div>
    </div>
    <!-- Nadpis -->
    ...
    <div class="first">
      ...
      <!-- tělo stránky -->
      <div class="hlavni"> 
        <h2 class="page-header">Cíle práce</h2>
