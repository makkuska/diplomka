...
<html lang="cs-cz" dir="ltr">
  <head>
    ...
    <title>Solanská - Synchronizace a replikace geodat v prostředí Esri platformy | Metody</title>
  </head>
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        ...
        <a class="blog-nav-item active" href="metody.php">Metody</a>
    ...
    <div class="first">
      ...
      <!-- tělo stránky -->
      <div class="hlavni"> 
        <h2 class="page-header">Metody</h2>
